...
# docker build -t il2 .
# xhost +
# docker run -i --rm --net=host --privileged=true -v /media/paul/IL2_1946:/mnt/cdrom -v /tmp/.X11-unix/X0:/tmp/.X11-unix/X0 -v /run/user/1000/pulse:/run/user/1000/pulse -v /home/paul:/home/paul il2
...
USER paul
WORKDIR /home/paul
CMD wine "c:\Program Files\Ubisoft\IL-2 Sturmovik 1946\il2fb.exe"
